...
*/
  ...
  podersabio: {
    name: "Poder Sabio",
    shortDesc:
      "Potencia ataques especiales x1.5 y te fija al primer ataque usado.",
    rating: 4.5,
    num: 10050,
    flags: {}, // ← NECESARIO
  ...
  illuminate: {
    onStart(pokemon) {
      ...
      for (const target of pokemon.adjacentFoes()) {
        // Igual que Intimidate: no baja stats detrás de Substitute
        if (
          !this.singleEvent(
            "TryHit",
    ...
    name: "Illuminate",
    shortDesc:
      "Al entrar, reduce en 1 nivel la precisión de los enemigos adyacentes.",
    rating: 3,
    num: 35,
  },
  illusion: {
