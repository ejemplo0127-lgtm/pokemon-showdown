export const AbilitiesText: { [id: IDEntry]: AbilityText } = {
  ...
  acometida: {
    name: "Acometida",
    shortDesc:
      "Al entrar al campo, +20% Ataque y +50% Velocidad hasta su primer turno.",
    desc: "Cuando este Pokémon entra al campo, sus estadísticas de Ataque y Velocidad se incrementan en +20% y +50% respectivamente hasta que use su primer movimiento. Esto se muestra en verde en la interfaz al pasar el ratón sobre el Pokémon.",
  },
  adaptability: {
    name: "Adaptability",
