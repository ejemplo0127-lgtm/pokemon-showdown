export const MovesText: { [id: IDEntry]: MoveText } = {
  ...
  triplegolpe: {
    name: "Triple golpe",
    desc: "Golpea hasta tres veces seguidas y cada vez más fuerte.",
    shortDesc: "Aumenta su potencia en cada golpe",
  },
  amorpostumo: {
    name: "Amor póstumo",
    desc: "Cuanta más amistad, mas fuerte golpea",
    shortDesc: "Como retribución pero fantasma",
  },
  escalofrio: {
    name: "Escalofrio",
  ...
  deslizamiento: {
    ...
    shortDesc: "Aumenta su velocidad",
  },
  absorb: {
    name: "Absorb",
