export const Pokedex: import("../sim/dex-species").SpeciesDataTable = {
  ...
  machampgmax: {
    ...
    types: ["Fighting"],
    genderRatio: { M: 0.75, F: 0.25 },
    baseStats: { hp: 90, atk: 160, def: 100, spa: 75, spd: 98, spe: 75 },
    abilities: { 0: "Guts", 1: "No Guard", H: "Steadfast" },
    heightm: 25,
    weightkg: 0,
    color: "Gray",
  ...
  laprasgmax: {
    ...
    abilities: { 0: "Water Absorb", 1: "Shell Armor", H: "Piel Helada" },
    heightm: 24,
    weightkg: 0,
    color: "Blue",
    eggGroups: ["Monster", "Water 1"],
  ...
  gallademega: {
    ...
    types: ["Psychic", "Fighting"],
    gender: "M",
    baseStats: { hp: 68, atk: 155, def: 95, spa: 75, spd: 115, spe: 110 },
  ...
  orbeetlegmax: {
    ...
    abilities: { 0: "Swarm", 1: "Frisk", H: "Neuroforce" },
    heightm: 14,
    weightkg: 0,
    color: "Red",
    eggGroups: ["Bug"],
  ...
  coalossalgmax: {
    ...
    forme: "Gmax",
    types: ["Rock", "Fire"],
    baseStats: { hp: 110, atk: 110, def: 140, spa: 110, spd: 110, spe: 40 },
    abilities: { 0: "Steam Engine", 1: "Flame Body", H: "Flash Fire" },
    heightm: 42,
    weightkg: 0,
    color: "Black",
  ...
  sandacondagmax: {
    ...
    abilities: { 0: "Sand Spit", 1: "Sand stream", H: "Sand Veil" },
    heightm: 22,
    weightkg: 0,
    color: "Green",
    eggGroups: ["Field", "Dragon"],
